...
var shop = function() {
    var shopOptionPrompt = window.prompt("Enter 1 to REFILL your health, 2 to UPGRADE your attack, or 3 to LEAVE the store? Please enter one: 1, 2, or 3 to make a choice.");
...
var enemyInfo = [
    ...
    {name: "Amy Andriod", attack: randomNumber(10,14)},
